...
/**
 * Exception throws during the execution of an algorithm. 
...
public class AlgorithmExecutionException extends ExecutionException {
    ...
    public AlgorithmExecutionException(String formatString, Throwable cause, Object... parameters) {
        super(formatString, cause, parameters);
    }

    public AlgorithmExecutionException(String message, Object... parameters) {
