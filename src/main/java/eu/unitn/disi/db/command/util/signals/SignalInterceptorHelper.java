// $Id: SignalInterceptorHelper.java,v 1.1 2005/03/05 18:32:53 Dave Exp $
/*
 ...
 */
package eu.unitn.disi.db.command.util.signals;
 ...
 * </p>
 */
public final class SignalInterceptorHelper implements SignalHandler {

    private final SignalHandler oldHandler;

    private final SignalInterceptor interceptor;

    public SignalInterceptorHelper(String signame, SignalInterceptor interceptor) {
